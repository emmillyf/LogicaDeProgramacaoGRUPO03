 ...
 * @POSICAO-CURSOR = 496; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {numero, 12, 10, 6}-{contNum, 12, 22, 7}-{numeroRepetido, 13, 10, 14}-{contNumRepetidos, 13, 30, 16}-{numeroNaoRepetido, 14, 10, 17}-{contNumNaoRepetidos, 14, 33, 19};
